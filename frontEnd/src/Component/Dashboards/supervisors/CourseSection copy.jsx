// export const CoursesSection = ({ coursesData,setAssignment, onViewCourse }) => {
...
//                     <div key={course.id} className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-200 cursor-pointer" onClick={() => setAssignment(course)}>
//                         <h4 className="text-lg font-bold text-gray-800 mb-2">{course.title}</h4>
//                         <p className="text-gray-600 text-sm mb-4">{course?.description?course.description:"null"}</p>
//                           <p className="text-gray-600 text-sm mb-4">{course?.createdAt?course.createdAt:"null"}</p>
