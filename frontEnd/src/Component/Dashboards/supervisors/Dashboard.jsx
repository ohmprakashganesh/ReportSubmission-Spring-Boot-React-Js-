                ...
                <div className="p-6 flex-1 overflow-y-auto">
                    {currentSection === 'dashboard' && (
                        <Dashboard
                            ...
                            onViewCourse={course => handleNavigate('course-details', course)}
                    ...
                    {currentSection === 'groups' && (
                        <GroupsSection
                            ...
                            onViewGroup={group => handleNavigate('group-details', group)}
                        />
                    )}
                    {currentSection === 'students' && (
                        <StudentsSection studentsData={studentsData} />
                    )}
                    ...
                    {currentSection === 'course-details' && currentCourse && (
                        <CourseDetails
                            ...
                            onViewAssignment={assignment => handleNavigate('assignment-details', assignment)}
                            onViewGroup={group => handleNavigate('group-details', group)}
                        />
                    )}
...
const Header = ({ sectionTitle }) => {
    ...
    return (
        <header className="bg-white p-4 shadow-md flex items-center justify-between sticky top-0 z-10">
            ...
            <h2 className="text-2xl font-semibold text-gray-800" id="currentSectionTitle">{sectionTitle}</h2>
...
const CoursesSection = ({ coursesData, onViewCourse }) => {
    return (
