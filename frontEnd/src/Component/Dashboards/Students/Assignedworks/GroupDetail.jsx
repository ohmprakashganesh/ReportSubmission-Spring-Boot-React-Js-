...
const GroupDetail = ({ group, assignments, onBack, onSubmitAssignment, allSubmissions }) => {
  ...
  // Sort assignments based on toggle
  const displayedAssignments = [...assignments].sort((a, b) => {
  ...
  return (
    <div className="p-4 bg-white rounded-lg shadow-md">
      ...
      >
        {sortByDueDate
          ? `Sorted by Due Date (${sortDirection === 'asc' ? 'Earliest First' : 'Latest First'})`
          : 'Sort by Due Date'}
      </button>
