...
const ViewGroup = ({ onClose ,grp}) => {
 ...
 const[assignment, setAssignment]=useState("");
  ...
  return (
  <div className="fixed  inset-0 bg-gray-300 bg-gradient-to-tr backdrop-blur-sm flex items-center justify-center p-4 z-50 overflow-y-auto animate-fadeIn">
  <div className="bg-white rounded-xl  mt-40 shadow-2xl p-6 w-full max-w-6xl transform transition-all duration-300 scale-100 opacity-100 animate-slideUp">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      {/* Assignments Card */}
      <div className="md:col-span-2 bg-gradient-to-br from-amber-50 to-orange-50 p-5 rounded-lg border border-amber-100 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {grp.assignments.map(assign => (
            <div key={assign.id} className="bg-white p-4 rounded-md border border-amber-200 shadow hover:shadow-md transition-shadow duration-200">
              ...
              <div className="flex justify-between items-center mt-3">
                <div className="flex items-center gap-2">
                  <button className="bg-blue-200 px-2 py-1 rounded-2xl text-xs font-medium">Total Submissions</button>
