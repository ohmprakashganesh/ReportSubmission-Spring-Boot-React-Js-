...
const ViewGroup = ({ onClose }) => {
  ...
  return (
    <div className="bg-amber-300 bg-gradient-to-tr overflow-y-scroll backdrop-blur-sm flex w-full items-center justify-center p-4 z-50 overflow-auto animate-fadeIn">
      <div className="bg-white rounded-xl shadow-2xl p-6 w-full wax-w-[80%] transform transition-all duration-300 scale-100 opacity-100 animate-slideUp">
        <div className="flex mt-52 justify-between items-center mb-6 pb-4 border-b border-gray-700">
          <div>
