...
const Dash = () => {
    ...
    return (
       ...
       <div>
       <nav className="bg-purple-600 z-50 w-full fixed text-white shadow-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className='flex-row w-[100%]  min-h-screen'>
           ...
           <main className="flex-1 p-8 w-full overflow-y-auto">
                ...
                <div id="assignUsersModal" className={`fixed w-full inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50 ${isAssignUsersModalOpen ? '' : 'hidden'}`}>
